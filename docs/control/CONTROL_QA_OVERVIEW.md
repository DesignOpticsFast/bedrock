...
Build and QA behavior for the Bedrock repository is governed by the shared CONTROL document:
...
Bedrock-specific build and QA implementation details are documented locally in:

- `CMakePresets.json` – Build presets and configurations
- `scripts/` – Build and test scripts
- `docs/` – Architecture, testing, and build documentation
- `docs/adr/` – Architecture Decision Records for Bedrock-specific choices
